...
//+kubebuilder:rbac:groups=managed.openshift.io,resources=suricata,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=managed.openshift.io,resources=suricata/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=managed.openshift.io,resources=suricata/finalizers,verbs=update
